...
class Contacts extends \common\models\BaseModel
{
    ...
    {
        ContactsLogStatus::deleteAll(['code' => $this->code, 'phone' => $this->phone]);
    ...
    {
        return parent::find()->andWhere(['{{contacts}}.country' => Yii::$app->cache->get('country')]); // TODO: Change the autogenerated stub
    }
