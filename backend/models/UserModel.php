...
class UserModel extends BaseModel implements IdentityInterface
{
    ...
    {
        return ['service_fee']; // TODO: Change the autogenerated stub
    }
    /**
     * @var mixed|null
     */
    ...
    {
        return $this->hasOne(AuthAssignment::className(), ['user_id' => 'id'])->where([
            '{{auth_item}}.type' => 1
        ]);
    }
    ...
    public function afterFind()
    {
        ...
        $this->permission = static::getPermission($this->id);
    ...
    public static function getPermission($id)
    {
        $arr = AuthAssignment::find()
            ...
            ->where([
                ...
                '{{%auth_item}}.rule_name' => 'Permission'
            ])->asArray()->all();
        return ArrayHelper::getColumn($arr, 'item_name', []);
    }
